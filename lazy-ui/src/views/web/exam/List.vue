  ...
  <div>
    <el-card style="background: rgb(246, 248, 253); border-radius: 0px; padding: 10px 0px;">
      <el-form label-width="68px">
        <el-input v-model="queryParams.title" @input="getList" placeholder="搜索考试名称" style="width: 200px"></el-input>
      </el-form>
    </el-card>
        ...
        <el-col :span="20">
          ...
          <div style="color: rgb(102, 102, 102); font-size: 12px;">
            <el-row>
              ...
              <el-col :span="8">考试时间： {{ item.limitTime ? item.startTime + '~' + item.endTime : '不限时' }}</el-col>
            </el-row>
          </div>
        </el-col>
