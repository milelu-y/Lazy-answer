...
public class ExperimentController extends BaseController {
 ...
 /* public static void main(String[] args) throws IOException {
    ...
    public AjaxResult BLHToXYZ() {
        ...
        bLH.setB(randomNumber());
        bLH.setL(randomNumber());
        bLH.setH(randomNumber());
    ...
    public AjaxResult XYZToBLH() {
        ...
        xYZl.setX(randomNumber());
        xYZl.setY(randomNumber());
        xYZl.setZ(randomNumber());
        Ellipsoid ellipsoid = new Ellipsoid();
        double X = xYZl.X;
        double Y = xYZl.Y;
        double Z = xYZl.Z;
    ...
    public AjaxResult XYZ2ENU() {
        ...
        ref_xyz.setX(randomNumber());
        ref_xyz.setY(randomNumber());
        ref_xyz.setZ(randomNumber());

        PointXYZ xyz = new PointXYZ();
        xyz.setX(randomNumber());
        xyz.setY(randomNumber());
        xyz.setZ(randomNumber());
    ...
    public Double dateToM() {
        ...
        String dates = String.valueOf(format.format(d));
        Date date = null;
        try {
...
//        gps
    ...
    public AjaxResult exp8_gps_dianLiCeng() {
        ...
        wx_xyz.setX(randomNumber());
        wx_xyz.setY(randomNumber());
        wx_xyz.setZ(randomNumber());

        PointXYZ user_xyz = new PointXYZ();
        user_xyz.setX(randomNumber());
        user_xyz.setY(randomNumber());
        user_xyz.setZ(randomNumber());
...
//        穿刺经度（l）、纬度（b)
        ...
        experimentResult.setResult10(k13);
...
//        得到BDS的电离层改正值
    ...
    public AjaxResult exp10_shuangpinDianLiCeng() {
        ...
        double B1I_f = randomNumber() * Math.pow(10, 6);
        double B3I_f = randomNumber() * Math.pow(10, 6);
        double P1 = randomNumber();
        double P3 = randomNumber();
        double Tgd = randomNumber() * Math.pow(10, -8);
